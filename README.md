...
1. **Core Frameworks**
- `ms-swift` (3.12.3): Required for SFT. Please refer to the (official SWIFT installation guide)[https://swift.readthedocs.io/en/latest/GetStarted/SWIFT-installation.html].
- `VERL` (0.8.0.dev0): The reinforcement learning pipeline is built on VERL, developed by ByteDance. Please follow the (VERL GitHub repository)[https://github.com/volcengine/verl] to build and install it from source.
